...
class __TwigTemplate_4e625abc7d5f91d845b66c607ac406cb0cd1c371a86643be0315b3d06e86018e extends Twig_Template
{
        ...
        if ($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "notcalledlisteners", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                ...
                echo "</code></td>
                    <td><code>";
                // line 51
                echo $context["__internal_20ad4ae5d9a426a8491d0c733ff022ea1af7dc610dee98cc8aae85570448b43e"]->getdisplay_listener($this->getAttribute((isset($context["listeners"]) ? $context["listeners"] : $this->getContext($context, "listeners")), $context["listener"], array(), "array"));
                echo "</code></td>
                </tr>
            ";
            }
...
{% macro display_listener(listener) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/events.html.twig", "C:\\wamp\\www\\github\\Gestion-de-Stage\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\events.html.twig");
    }
}
