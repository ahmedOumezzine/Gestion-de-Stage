 ...
 */
class Stage extends \Admin\UsersBundle\Entity\Stage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\UsersBundle\\Entity\\Stage' . "\0" . 'idStage', '' . "\0" . 'Admin\\UsersBundle\\Entity\\Stage' . "\0" . 'sujetStage', '' . "\0" . 'Admin\\UsersBundle\\Entity\\Stage' . "\0" . 'dateDebut', '' . "\0" . 'Admin\\UsersBundle\\Entity\\Stage' . "\0" . 'dateFin', '' . "\0" . 'Admin\\UsersBundle\\Entity\\Stage' . "\0" . 'affect', '' . "\0" . 'Admin\\UsersBundle\\Entity\\Stage' . "\0" . 'idTechnologie', '' . "\0" . 'Admin\\UsersBundle\\Entity\\Stage' . "\0" . 'idDepartement', '' . "\0" . 'Admin\\UsersBundle\\Entity\\Stage' . "\0" . 'idTypestage'];
        }
